...
public class QuoteAdapter extends RecyclerView.Adapter<Holder> {
  ...
  private final String unnattributedSource;
  ...
  public QuoteAdapter(Context context, List<QuoteWithSource> quotes) {
    ...
    this.quotes = quotes;
    unnattributedSource = context.getString(R.string.unattributed_source);
  ...
  class Holder extends RecyclerView.ViewHolder {
    ...
    private void bind(int position) {
      ...
      String sourceName =
          (item.getSource() != null) ? item.getSource().getName() : unnattributedSource;
